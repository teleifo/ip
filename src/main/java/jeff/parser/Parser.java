    ...
    public static Command parseCommand(String userInput) throws JeffException {
        ...
        case "deadline":
            ...
            if (description.isEmpty()) {
                throw new JeffException("Deadline `description` cannot be empty.\nFormat: deadline [description] /by [due by]");
            }
            if (by.isEmpty()) {
                throw new JeffException("Deadline `by` cannot be empty.\nFormat: deadline [description] /by [due by]");
            }
            if (!Utils.isDate(by) && !Utils.isDateTime(by)) {
                throw new JeffException("Deadline `by` should follow this format:\nyyyy-MM-dd OR yyyy-MM-ddTHH:mm");
            }
